...
NB: At startup, the input boxes are grayed out to indicate that no file is created. If you just want to open an existing file without creating a new one, do not touch the input boxes.
