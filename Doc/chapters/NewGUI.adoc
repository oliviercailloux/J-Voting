...
| We had listeners on all the controls present in the default view when we enter the app. 
...
- Or we send the whole new model to the view and she takes care of rendering all element. 
