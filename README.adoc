...
* 3#  Preferences : Implement AntiSymmetricPreferenceImpl
* 4#  Preferences : Implement CompletePreferenceImpl
* 5#  Preferences : Implement LinearPreferenceImpl
* 7#  Preferences : Implement MutableAntiSymmetricPreferenceImpl
* 8#  Preferences : Implement ImmutableAntiSymmetricPreferenceImpl
