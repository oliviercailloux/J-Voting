...
=== Tasks :
* 1#  Preferences : Rename StrictCompletePreferenceImpl in LinearPreferenceImpl 
...
* 3#  Preferences : Implement the first preferences class : MutablePreferenceImpl
...
* 6#  Preferences : Implement NewCompletePreferenceImpl and NewLinearPreferenceImpl
