...
public class ProfileHelper {
	...
	public static BiMap<Alternative, String> alternativeNamesTCF = ImmutableBiMap.of(a1, "Tartiflette", a2,
			"Couscous", a3, "Fondue Savoyarde");
	public static BiMap<Alternative, String> alternativeNamesTP = ImmutableBiMap.of(a1, "Tartiflette", a2,
			"Pâte au saumon");
	
	public static BiMap<Voter, String> voterNamesLTJ4 = ImmutableBiMap.of(v1, "Pierre", v2, "Thomas", v3, "Jade",
			v4, "Voter 4");
	...
	public static MutableStrictProfile mspa123v1234 = MutableStrictProfile.given(profilea123v1234,
			alternativeNamesTPF, voterNamesLTJ4);
	public static MutableStrictProfile mspa12v12 = MutableStrictProfile.given(profilea12v12, alternativeNamesTPF,
			voterNamesPT);
	public static MutableStrictProfile mspa123v123 = MutableStrictProfile.given(profilea123v123,
			alternativeNamesTPF, voterNamesLTJ);
	public static MutableStrictProfile mspa1234v123 = MutableStrictProfile.given(profilea1234v123,
			alternativeNamesTPFA, voterNamesPTJ);
