...
class MutablePreferenceImplTest {
    ...
    /**
     * Tests whether method getAlternatives modifies the corresponding graph if
     * the alternatives set is modified.
     */
    @Test
    void testGetAlternatives1() {
        Alternative a1 = Alternative.withId(1);
        Alternative a2 = Alternative.withId(2);
        Alternative a3 = Alternative.withId(3);
        Alternative a4 = Alternative.withId(4);
        ...
        MutablePreferenceImpl pref = MutablePreferenceImpl.given(
                        MutablePreferenceImpl.preferenceGraphMaker(setTest),
                        Voter.createVoter(1));
        Set<Alternative> a = Set.copyOf(pref.getAlternatives());
        pref.addAlternative(a6);
        a.add(a6);
        assertEquals(a, pref.getAlternatives());
    }
}
