...
public class MutablePreferenceImpl implements MutablePreference {
	...
	private MutablePreferenceImpl(MutableGraph<Alternative> prefGraph, Voter voter) {
		this.voter = voter;
		graph = prefGraph;
	}
	 ...
	 *                        linear comparison of sets of alternatives. (first in
	 *                        the list is preferred to next ones, etc.) Those sets
	 *                        of alternatives contain ex-aequo alternatives.
	 ...
	 */
	public static MutablePreferenceImpl of(Set<List<Set<Alternative>>> pref, Voter voter) {
		LOGGER.debug("MutablePreferenceImpl of Factory");
		Preconditions.checkNotNull(pref);
		Preconditions.checkNotNull(voter);
		return new MutablePreferenceImpl(preferenceGraphMaker(pref), voter);
	}
