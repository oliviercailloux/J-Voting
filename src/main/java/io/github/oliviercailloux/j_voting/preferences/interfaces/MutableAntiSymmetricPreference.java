...
public interface MutableAntiSymmetricPreference
     ...
     * reflexive
     *
     * @see MutableAntiSymmetricPreference#asGraph() TODO : should forbid
     *      removing alternative from the set of nodes (surprising results when
     *      a > b > c and removing b as it might disconnect the graph)
     */
    public MutableGraph<Alternative> asMutableGraph();

    /**
     * Adds an alternative to the Preference. This alternative is not preferred
     * to any other of the preference, it is being added isolated.
     *
    ...
    /**
     * Adds an edge from a1 to a2, so that a1 is preferred to a2 (a1 > a2). If
     * one of them is not in the graph, they are added.
     *
